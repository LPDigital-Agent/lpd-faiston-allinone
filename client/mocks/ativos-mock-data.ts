...
export const mockShippingOrders: ShippingOrder[] = [
  ...
  },
  {
    ...
    responsavel: mockUsers[4],
    itens: [
      { ativoId: "asset-004", ativoCodigo: "FAI-KB-001", ativoNome: "Teclado Logitech MX Keys", quantidade: 10 },
    ],
    dataCriacao: "2024-12-10T09:00:00Z",
    dataPrevista: "2024-12-14T18:00:00Z",
    dataEnvio: "2024-12-11T14:00:00Z",
    dataEntrega: "2024-12-13T10:00:00Z",
    rastreio: "BR987654321RJ",
  },
];
...
export const mockReturnRequests: ReturnRequest[] = [
    ...
    timeline: [
      {
        ...
        descricao: "Solicitação de devolução registrada",
        responsavel: "Carlos Oliveira",
      },
      {
        id: "tl-002",
        data: "2024-12-18T14:00:00Z",
        descricao: "Aprovada para coleta",
        responsavel: "Ana Martins",
      },
      {
        id: "tl-003",
        data: "2024-12-19T09:00:00Z",
        descricao: "Coletado pela transportadora",
  ...
  },
  {
    ...
    timeline: [
      {
        id: "tl-004",
        data: "2024-12-17T15:00:00Z",
        descricao: "Solicitação de troca registrada",
  ...
  },
  {
    ...
    codigo: "REV-2024-003",
    ativoId: "asset-003",
    cliente: "Filial São Paulo",
    solicitante: mockUsers[2],
    motivo: "garantia",
    status: "recebido",
    descricao: "Monitor apresentando defeito na tela - garantia válida",
    dataSolicitacao: "2024-12-15T11:00:00Z",
    dataConclusao: "2024-12-18T16:00:00Z",
    responsavel: mockUsers[0],
    timeline: [
      {
        id: "tl-005",
        data: "2024-12-15T11:00:00Z",
        descricao: "Solicitação de garantia aberta",
        responsavel: "João Ferreira",
      },
      {
        id: "tl-006",
        data: "2024-12-16T09:00:00Z",
        descricao: "Enviado para análise técnica",
        responsavel: "Fábio Santos",
      },
      {
        id: "tl-007",
        data: "2024-12-18T16:00:00Z",
        descricao: "Recebido no centro de distribuição",
  ...
  },
  {
    ...
    codigo: "REV-2024-004",
    ativoId: "asset-006",
    cliente: "Departamento Financeiro",
    solicitante: mockUsers[4],
    motivo: "desuso",
    status: "rejeitado",
    descricao: "Impressora antiga - solicita devolução ao estoque",
    dataSolicitacao: "2024-12-14T10:00:00Z",
    timeline: [
      {
        id: "tl-008",
        data: "2024-12-14T10:00:00Z",
        descricao: "Solicitação de devolução registrada",
        responsavel: "Pedro Costa",
      },
      {
        id: "tl-009",
        data: "2024-12-15T14:00:00Z",
        descricao: "Rejeitada - equipamento em uso por outro departamento",
...
export const mockMessages: InternalMessage[] = [
  ...
  {
    id: "msg-004",
    assunto: "Solicitação de Transferência - Notebook Dell XPS",
    conteudo: "Solicito transferência do notebook Dell XPS (FAI-NB-001) para o setor de Marketing conforme requisição aprovada pela gerência.",
    remetente: mockUsers[2],
    remetenteId: mockUsers[2].id,
    departamento: "Operações",
    categoria: "solicitacao",
    prioridade: "normal",
    lida: false,
    favorita: false,
    dataEnvio: "2024-12-19T11:30:00Z",
  },
  {
    id: "msg-005",
    assunto: "Aprovação de Baixa de Ativo - Mesa Reunião",
    conteudo: "Conforme solicitado, a baixa do ativo FAI-MOB-002 (Mesa de Reunião) foi aprovada. Por favor, proceder com a documentação fiscal.",
    remetente: mockUsers[4],
    remetenteId: mockUsers[4].id,
    departamento: "Financeiro",
    categoria: "aprovacao",
    prioridade: "normal",
    lida: true,
    favorita: false,
    dataEnvio: "2024-12-18T10:00:00Z",
  },
  {
    id: "msg-006",
    assunto: "Alerta: Garantia Expirando",
    conteudo: "Atenção! A garantia do equipamento FAI-NB-003 (Notebook ThinkPad) expira em 7 dias. Verificar necessidade de renovação ou manutenção preventiva.",
    remetente: mockUsers[0],
    remetenteId: mockUsers[0].id,
    departamento: "TI",
    categoria: "alerta",
    ...
    lida: false,
    favorita: true,
    dataEnvio: "2024-12-19T08:00:00Z",
  },
];
