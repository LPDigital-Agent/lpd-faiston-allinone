...
// =============================================================================
// Inventory Campaign Detail Page - SGA Inventory Module
// =============================================================================
    ...
    <div className="space-y-6">
          ...
          <GlassCard>
            <GlassCardHeader>
              <div className="flex items-center gap-2">
                ...
                <GlassCardTitle>Divergências Detectadas</GlassCardTitle>
              ...
              {divergences.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  ...
                  <p className="text-sm text-text-muted">
                    Nenhuma divergência encontrada ainda
                  </p>
                </div>
              ) : (
      ...
      {!isCountingSessionActive && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <GlassCard className="p-4">
            <p className="text-xs text-text-muted mb-1">Divergências</p>
