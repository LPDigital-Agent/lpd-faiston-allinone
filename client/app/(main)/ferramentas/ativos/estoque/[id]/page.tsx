...
// =============================================================================
// Asset Detail Page - SGA Inventory Module
// =============================================================================
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[50vh] text-center">
        ...
        <p className="text-sm text-text-muted mb-4">
          {typeof error === 'string' ? error : 'O ativo solicitado não existe ou foi removido.'}
        </p>
        <Button asChild>
          ...
          <GlassCard>
            <GlassCardHeader>
              <div className="flex items-center gap-2">
                ...
                <GlassCardTitle>Informações do Ativo</GlassCardTitle>
              </div>
            </GlassCardHeader>
            <GlassCardContent>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-text-primary">
                    {asset.project_id || 'Não vinculado'}
                  </p>
                </div>
                <div>
          ...
          <GlassCard>
            <GlassCardHeader>
              <div className="flex items-center gap-2">
                ...
                <GlassCardTitle>Localização</GlassCardTitle>
              </div>
            </GlassCardHeader>
            <GlassCardContent>
              <div className="grid grid-cols-2 gap-4">
            ...
            <GlassCardHeader>
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center gap-2">
                  ...
                  <GlassCardTitle>Histórico de Movimentações</GlassCardTitle>
                </div>
